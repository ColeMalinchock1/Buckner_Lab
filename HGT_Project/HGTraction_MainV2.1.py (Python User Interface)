...
################################################################################
## Form generated from reading UI file 'HGTui_mainScreenV2bUJdLs.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget_2.setGeometry(QRect(180, 280, 81, 81))
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"NCSU MAE Halo Gravity Traction", None)) #  !!!!!!!!!!!!!!!
